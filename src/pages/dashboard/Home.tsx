  ...
  return (
    <Layout title="Dashboard">
      <div className="flex gap-2">
        <h4 className="text-[#000000] text-[24px] font-[400] ">
          Welcome back,{" "}
          <span className="text-[#164988] font-[700] ">Tlag Entertainment</span>
        </h4>
        <img src={hand} alt="Logo" className="" />
      </div>
      <h4 className="text-[#000000] text-[16px] mt-2 font-[400] ">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className="bg-[#164988] shadow-md pl-5 pr-8 py-7  text-white rounded-[20px]">
          ...
          <h3 className="text-[24px] font-[700] pb-5">
            {show ? "₦9,846.18" : "*****"}
          </h3>
        ...
        <div className="bg-[#FFFFFF] shadow-md pl-5 pr-8 pt-7 pb-4 rounded-[20px]">
          ...
          <h4 className="text-[12px] mt-1 font-[400] text-[#000000]">
            Total Disbursement{" "}
          </h4>
          <h4 className="text-[24px] font-[700] text-[#000000]">
            ₦ -50,000.00
          </h4>
      ...
      <table className="w-full text-sm text-left text-gray-500 border-1 border-[#36A2EB] rounded-t-[10px]">
        ...
        <tbody>
          <tr className="bg-white border-b border-b-[#36A2EB]">
            ...
            <td className="px-6 whitespace-nowrap py-4">Michael Jordan</td>
            <td className="px-6 py-4">Uniswitch/05/02/1779</td>
            <td className="px-6 py-4">micheal@uniswitch.com</td>
            <td className="px-6 py-4">00000000000</td>
          ...
          <tr className="bg-white border-b border-b-[#36A2EB]">
            ...
            <td className="px-6 py-4">Michael Jordan</td>
            <td className="px-6 py-4">Uniswitch/05/02/1779</td>
            <td className="px-6 py-4">micheal@uniswitch.com</td>
            <td className="px-6 py-4">00000000000</td>
            <td className="px-6 py-4">Engineering</td>
